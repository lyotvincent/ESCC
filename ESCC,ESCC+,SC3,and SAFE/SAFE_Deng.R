for( tot in 1:100)
{
  ...
  cluster.ensemble <- SAFE(cluster_results = cluster.results, program.dir = "~/Downloads/SAFEclustering-master/gpmetis_and_shmetis_for_Linux", k_min=10,k_max=10,MCLA = TRUE, CSPA = TRUE, HGPA = TRUE, SEED = 123)
  library(cidr)
