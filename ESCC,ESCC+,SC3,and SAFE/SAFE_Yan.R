for( tot in 1:100)
{
  ...
  cluster.ensemble <- SAFE(cluster_results = cluster.results, program.dir = "path for gpmetis_and_shmetis_for_Linux", k_min=7,k_max=7,MCLA = TRUE, CSPA = TRUE, HGPA = TRUE, SEED = 123)
  library(cidr)
