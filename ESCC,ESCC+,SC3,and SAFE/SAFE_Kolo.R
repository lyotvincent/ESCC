for( tot in 1:96)
{
  ...
  matrix_filtered=2**data[which(gene_filter),1:704]
  ...
  library(cidr)
  cat(cluster.ensemble$optimal_clustering,file="~/Desktop/bicluster-evolotionary/Gold (another copy)/Final/Result (5th copy)/SAFE2_Kolo.txt",append=TRUE)
  cat("\n",file="~/Desktop/bicluster-evolotionary/Gold (another copy)/Final/Result (5th copy)/SAFE2_Kolo.txt",append=TRUE)
}