for( tot in 1:1)
{
  ...
  matrix_filtered=data[which(gene_filter),1:268]
  ...
  library(cidr)
  cat(cluster.ensemble$optimal_clustering,file="~/Desktop/bicluster-evolotionary/Gold (another copy)/Final/Result (5th copy)/SAFE_Deng.txt",append=TRUE)
  cat("\n",file="~/Desktop/bicluster-evolotionary/Gold (another copy)/Final/Result (5th copy)/SAFE_Deng.txt",append=TRUE)
}