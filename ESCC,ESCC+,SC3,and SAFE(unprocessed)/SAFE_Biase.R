for( tot in 1:100)
{
  ...
  library('tidyverse')
  a<-read_rds('~/Desktop/bicluster-evolotionary/Gold (another copy)/Final/Result (5th copy)/biase(changed).rds')
  print(a)
  ...
  matrix_filtered=data[which(gene_filter),1:49]
  ...
  library(cidr)
  cat(cluster.ensemble$optimal_clustering,file="~/Desktop/bicluster-evolotionary/Gold (another copy)/Final/Result (5th copy)/SAFE_Biase.txt",append=TRUE)
  cat("\n",file="~/Desktop/bicluster-evolotionary/Gold (another copy)/Final/Result (5th copy)/SAFE_Biase.txt",append=TRUE)
}